...
<div style="text-align:center;">
    <div style="display:inline-block; margin-right: 80px;">
        ...
        <div class="image-description">Meritxell Bach<br>Cuadra, University of Lausanne<br>Lausanne University Hospital<br><br><br><br></div>
    </div>
...
<div style="text-align:center;">
    ...
    <div style="display:inline-block; margin-right: 80px;">
        ...
        <div class="image-description">Diego Fajardo-Rojas<br>King’s College London<br><br><br><br></div>
    </div>
...
<img src="/images/logos.png" alt="PIPPI" style="width:100%;">